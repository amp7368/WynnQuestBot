...
public class QuestReccomendationMessageClass extends QuestRecommendationMessage {
    ...
    public String makeMessage() {
        String messageText = String.format("**Options for %s | %s, Lvl: %d/%d, Dungeons: %d**\n",
                choiceArguments.player.name, wynncraftClass.namePretty, wynncraftClass.combatLevel, wynncraftClass.totalLevel, wynncraftClass.dungeonsWon)
                + "<" + spreadsheetId + ">\n"
